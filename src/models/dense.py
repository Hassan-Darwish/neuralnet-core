...
class Dense(Layer):
    ...
    def __init__(self,
                 ...
                 use_bias: bool = True,
                 kernel_initializer: str = 'he') -> None:
    ...
    def forward(self, inputs: NDArray[np.float32]) -> Optional[NDArray[np.float32]]:
        ...
        if not self.initialized:
            ...
            fan_in = inputs.shape[self.FEATURE_INDEX]
    ...
    def _init_weights(self, 
                      fan_in: int, 
                      fan_out: int,
                      method: str = 'he') -> NDArray[np.float32]:
        ...
        Args:
            ...
            method (str): The name of the initialization method ('he' or
                          'xavier').
